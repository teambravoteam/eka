		...
		<div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="card shadow mb-4">
                <div class="card-body">
                        ...
                        <form method="post" action="add_regist_consulting">
                         <tr>
                            <th>신청자이름</th>
                            ...
                            <td>
                              ...
                              - <input type="text" name="phone2" class="phone"> - <input type="text" name="phone3" class="phone">
                          </td>
                          </tr>
                          <tr>
                            <th>신청일자</th>
                            <td><input type="date" name="applyDate"></td>
                            <th>상담일자</th>
                          ...
                          <tr>
                           <th>상담유형</th>
                          <td>                              
                              <input type="text" name="consultCategory">
                            </td> 
                           <th>신청내용</th>
                          <td>                              
                              <input type="text" name="consultDetail">
                            </td>                                                                                                   
                          </tr>  
                          <tr>
                           <th>상담내용</th>
