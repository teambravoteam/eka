...
<head>
  ...
  <link href="../resources/manager/custom/css/attendance.css" rel="stylesheet">
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                     <c:forEach var="lectureStudent" items="${lectureStudentList}" varStatus="status">                    
                   		<tr>
                        	<td>${status.count}</td>
